...
async def process_submission(
    ...
    try:
        ...
        # Сначала проверка на AI-генерацию (для передачи уверенности в основной промпт)
        ...
        # Жёсткое правило: незачет за AI только при высокой уверенности
        if ai_check and ai_check.get('ai_detected', False):
