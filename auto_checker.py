...
async def get_binary_evaluation(
    ...
    base_prompt = f"""
Ты - строгий эксперт по оценке студенческих работ. Твоя задача - оценить работу студента ЧЁТКО по критериям.
...
2. НЕ ЗАЧТЕНО - если работа содержит БОЛЬШЕ НЕСКОЛЬКИХ из следующих признаков:
